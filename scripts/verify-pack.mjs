...
//
// For each of the 11 packages it runs a real `pnpm pack --pack-destination
...
//   (c) the packed package.json has no `workspace:` protocol left — every
...
if (passed !== total) {
  console.error('[verify-pack] one or more packages are not publishable — aborting release.');
  process.exit(1);
}
